...
git commit -m "Optimize SDET profile for Viasat CI/CD role"
```
...
During optimization for a Viasat role, I had to confront two gaps:
...
### Day 1: Found a Role
> Viasat – Lead CI/CD Automation Software Engineer
