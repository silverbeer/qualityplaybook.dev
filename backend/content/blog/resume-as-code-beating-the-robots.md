...
git commit -m "Optimize SDET profile for REDACTED CI/CD role"
```
...
During optimization for a REDACTED role, I had to confront two gaps:
...
### Day 1: Found a Role
> REDACTED – Lead CI/CD Automation Software Engineer
