<template>
  <div>
    ...
    <section class="bg-gray-100 py-16">
      <div class="container-custom">
        <h2 class="text-3xl font-bold text-gray-900 text-center mb-12">What You'll Find Here</h2>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="bg-white p-6 rounded-lg shadow-md">
            <div class="text-primary-600 text-4xl mb-4">🧪</div>
            <h3 class="text-xl font-bold mb-3">Testing Strategies</h3>
            <p class="text-gray-700">
              Deep dives into test automation, frameworks, and quality engineering best practices.
            </p>
          </div>
          <div class="bg-white p-6 rounded-lg shadow-md">
            <div class="text-primary-600 text-4xl mb-4">⚙️</div>
            <h3 class="text-xl font-bold mb-3">Tools & Tech</h3>
            <p class="text-gray-700">
